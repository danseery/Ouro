...
const ALL_UPGRADES = {
  fang_sharpening:   { id:'fang_sharpening',   name:'Fang Sharpening',    description:'Each press tears deeper. +0.5% Essence per press per level.',                                         effect:UE.ESSENCE_PER_PRESS,    value_per_level:0.005,  base_cost:200,   max_level:50, tier:0, cosmic_only:false },
  ...
  digestive_enzymes: { id:'digestive_enzymes',  name:'Digestive Enzymes',  description:'Digest even while resting. +0.5% idle income per level.',                                            effect:UE.IDLE_INCOME_MULT,     value_per_level:0.005,  base_cost:400,  max_level:50, tier:0, cosmic_only:false },
  ...
  growth_hormone:    { id:'growth_hormone',      name:'Growth Hormone',     description:'Break through combo ceilings. +0.1 max combo tier per level.',                                        effect:UE.MAX_COMBO_MULT_BONUS, value_per_level:0.1,   base_cost:1200, max_level:30,  tier:0, cosmic_only:false },
  ...
  ouroboros_rhythm:  { id:'ouroboros_rhythm',    name:'Ouroboros Rhythm',   description:'+7% Essence per press, stacks with Fang Sharpening.',                                              effect:UE.ESSENCE_PER_PRESS,    value_per_level:0.07,   base_cost:800,  max_level:50,  tier:1, cosmic_only:false },
